...
public class TraceabilityListCellRenderer extends DefaultListCellRenderer {
    ...
    public Component getListCellRendererComponent(JList<?> list, Object value, int index, boolean isSelected, boolean cellHasFocus) {
        ...
        createString(panel, classNode, otherClassNode, traceLinkValue);
        if(isSelected)
        {
     ...
     * @return
     */
    private void createString(JPanel panel, final ClassNode classNode , final ClassNode otherclassNode, double tracelinkValue)
    {
