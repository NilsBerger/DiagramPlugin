...
public class TraceabilityCompLayouterAction extends AbstractGraphAction<Graph2D> {
    private final ImpactAnalysisGraph _impactAnalysisGraph;


    public TraceabilityCompLayouterAction(ImpactAnalysisGraph graph) {
    ...
    protected void actionPerformed(AnActionEvent anActionEvent, Graph2D graph2D) {
        ...
        if (project != null) {
            ...
            if (builder != null) {
                TraceabilityCompLayouter traceabilityLayouter = new TraceabilityCompLayouter();
