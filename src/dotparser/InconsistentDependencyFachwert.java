...
public class InconsistentDependencyFachwert implements DependencyIF
{
    private final ClassNodeMaterial dependentClass;
    private final ClassNodeMaterial independentClass;

    public InconsistentDependencyFachwert(final DependencyFachwert dependency)
    {
    ...
    public boolean equals(Object obj) {
        ...
        if(this.getClass() != obj.getClass())
            return false;
        final InconsistentDependencyFachwert otherClassNodeFachwert = (InconsistentDependencyFachwert) obj;
